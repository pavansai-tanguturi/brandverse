...
<<<<<<< HEAD
          ...
          <div className="flex items-center lg:ml-6 space-x-2">
            ...
            <button 
              ...
              className="p-2 rounded-full text-white/90 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-emerald-600 transition-colors"
            >
