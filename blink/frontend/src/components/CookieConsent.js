            ...
            <div className="flex items-start gap-4 flex-1">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm mb-3">
                  ...
                  experience on our website. We use essential cookies for
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg mb-3 text-sm">
                    ...
                    <ul className="space-y-1 text-gray-600">
                      <li>
                        ...
                        shopping cart, and basic site functionality
                      </li>
                      <li>
                        <strong>Session Cookies:</strong> Keep you logged in
                        during your visit
                      </li>
                      <li>
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                      We do not use tracking cookies or share your data with
