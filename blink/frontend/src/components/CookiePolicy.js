    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <h2 className="text-lg font-semibold text-blue-800 mb-2">Your Current Cookie Preferences</h2>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-green-500 pl-4">
              <h3 className="text-lg font-semibold text-green-700 mb-2">✅ Essential Cookies (Required)</h3>
              ...
              <p className="text-sm text-gray-500 mt-2">
                <strong>Cookie name:</strong> brandverse.sid | <strong>Duration:</strong> 7 days | <strong>Purpose:</strong> Session management
              </p>
            </div>

            <div className="border-l-4 border-yellow-500 pl-4">
              <h3 className="text-lg font-semibold text-yellow-700 mb-2">⚡ Performance Cookies (Optional)</h3>
              <p className="text-gray-600 mb-2">
              ...
              <p className="text-sm text-gray-500 mt-2">
                <strong>Note:</strong> Currently not implemented - we don't use tracking cookies
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="border border-yellow-300 rounded-lg p-4 text-center">
              <h3 className="font-semibold text-yellow-700 mb-2">Essential Only</h3>
              <p className="text-sm text-gray-600 mb-3">
        ...
        {/* Browser controls */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Browser controls</h2>
          <p className="text-gray-600 mb-4">
        ...
        <section className="bg-gray-50 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-3">Questions about our cookie policy?</h2>
          <p className="text-gray-600 mb-4">
            If you have any questions about how we use cookies, please contact us:
          </p>
          <div className="text-gray-600">
            <p><strong>Email:</strong> {process.env.REACT_APP_ADMIN_EMAIL || 'privacy@brandverse.com'}</p>
