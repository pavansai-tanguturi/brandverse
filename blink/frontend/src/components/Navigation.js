          ...
          <div className="flex items-center space-x-3">
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                <Link 
                  to="/dashboard"
                  className="hidden sm:flex items-center px-3 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 border border-blue-600 rounded-md hover:bg-blue-50 transition-colors"
                >
      ...
      <aside className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link 
            ...
            className="flex items-center px-3 py-2 text-gray-700 rounded-md hover:bg-blue-50 hover:text-blue-700 transition-colors"
          >
            <CartIcon className="w-5 h-5 mr-3" strokeColor="currentColor" />
            Cart
          </Link>
