...
const AdminOrders = () => {
  ...
  const isDeliveryRestricted = (order) => {
    ...
    const isAllowed = deliveryLocations.some(location => 
                            ...
                            <div className="flex flex-wrap gap-2">
                              {canAccept(order.status) && (
                                <button
                                  ...
                                  disabled={isButtonDisabled(order.id) || isRestricted}
                                  className={getButtonStyle('accepted', isButtonDisabled(order.id) || isRestricted)}
                                >
                              ...
                              {canStartPacking(order.status) && (
                                <button
                                  ...
                                  disabled={isButtonDisabled(order.id) || isRestricted}
                                  className={getButtonStyle('packing', isButtonDisabled(order.id) || isRestricted)}
                                >
                              ...
                              {canMarkReady(order.status) && (
                                <button
                                  ...
                                  disabled={isButtonDisabled(order.id) || isRestricted}
                                  className={getButtonStyle('ready', isButtonDisabled(order.id) || isRestricted)}
                                >
                              ...
                              {canShip(order.status) && (
                                <button
                                  ...
                                  disabled={isButtonDisabled(order.id) || isRestricted}
                                  className={getButtonStyle('shipped', isButtonDisabled(order.id) || isRestricted)}
                                >
                              ...
                              {canDeliver(order.status) && (
                                <button
                                  ...
                                  disabled={isButtonDisabled(order.id) || isRestricted}
                                  className={getButtonStyle('delivered', isButtonDisabled(order.id) || isRestricted)}
                                >
                              ...
                              {canReject(order.status) && (
                                <button
                                  ...
                                  disabled={isButtonDisabled(order.id) || isRestricted}
                                  className={getButtonStyle('cancelled', isButtonDisabled(order.id) || isRestricted)}
                                >
