  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        if (data.isAdmin) {
          setMessage(
            "Admin OTP sent to your email. Please check and enter the verification code.",
          );
        } else {
          setMessage(
            "OTP sent to your email. Please check and enter the verification code.",
          );
        }
        setStep(2);
      } else {
      ...
      if (response.ok) {
        if (data.admin) {
          ...
          if (data.token) {
            ...
            setError(
              "Authentication successful but no token received. Please try again.",
            );
          }
        } else {
            ...
            >
              ...
              <button
                ...
                style={{
                  width: "100%",
                  backgroundColor:
                    loading || !otp || otp.length !== 6 ? "#9ca3af" : "#059669",
                  color: "white",
                  padding: "0.75rem",
                  border: "none",
                  borderRadius: "6px",
