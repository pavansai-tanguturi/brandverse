    ...
    <>
      ...
      <div className="px-4 py-10 max-w-6xl mx-auto mt-24">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 mb-8 flex flex-col gap-4">
          ...
          {success && <div className="text-green-600 text-sm bg-green-50 p-3 rounded border">{success}</div>}
          {error && <div className="text-red-600 text-sm bg-red-50 p-3 rounded border">{error}</div>}
        </form>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-10">
          {banners.map((banner) => (
            <div key={banner.id} className="bg-white rounded-2xl border border-gray-200 flex flex-col items-center min-h-[340px] lg:min-h-[420px] w-full px-6 py-8 md:px-8 md:py-10 mb-4">
              ...
              {banner.color && (
                <div className="text-sm text-gray-500 mb-2">
                  Color: <span style={{ color: banner.color }}>{banner.color}</span>
                </div>
              )}
