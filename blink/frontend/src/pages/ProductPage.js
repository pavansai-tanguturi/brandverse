...
const ProductPage = () => {
  ...
  const fetchRelatedProducts = useCallback(
    async (categorySlug, currentProductId) => {
      try {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 max-w-7xl pb-20 lg:pb-6">
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex justify-center items-center gap-2 z-20">
                  {productImages.map((_, index) => (
                    <button
                      key={index}
                      onClick={() =>
                        startTransition(() => setSelectedImage(index))
                      }
                      className={`w-3 h-3 rounded-full border backdrop-blur bg-white/30 shadow-md transition-all duration-200 focus:outline-none ${
                        selectedImage === index
                          ? "border-emerald-500 bg-emerald-400/60 scale-110"
                          : "border-gray-300 bg-gray-200/40"
          ...
          <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between">
                  <span className="font-medium text-gray-900 text-sm sm:text-base">
                    {currentSizeChart.title}
                  </span>
                  <button className="text-emerald-600 text-xs sm:text-sm font-medium">
                    Size Guide
                  </button>
                </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="flex items-center border border-gray-300 rounded-md">
                  ...
                  <button
                    onClick={() =>
                      setQuantity(
                        Math.min(product.stock_quantity || 99, quantity + 1),
                      )
                    }
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center text-gray-600 hover:bg-gray-100 disabled:text-gray-300 transition-colors"
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <button
                ...
                className="flex-1 px-4 sm:px-8 py-3 sm:py-4 border border-emerald-600 text-emerald-600 font-medium rounded-lg hover:bg-emerald-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base shadow-sm hover:shadow-md"
              >
                {addingToCart ? (
                  <>
            ...
            <div className="border-t border-gray-200 pt-4 sm:pt-6 space-y-3 sm:space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">
                    Easy 14 days return and exchange available
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="border-t border-gray-200 pt-6 sm:pt-8 mb-20 lg:mb-6">
                ...
                <div key={relatedProduct.id} className="group">
                  <Link to={`/product/${relatedProduct.id}`} className="block">
                    ...
                    <div className="space-y-1">
                      <h3 className="font-medium text-gray-900 text-xs sm:text-sm line-clamp-2 group-hover:text-emerald-600 leading-tight">
                      ...
                      <div className="flex items-center gap-1 sm:gap-2">
                        <span className="font-semibold text-gray-900 text-xs sm:text-sm">
                          ₹
                          {calculateDiscountedPrice(
                            relatedProduct.price_cents / 100,
