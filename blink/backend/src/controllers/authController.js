...
export const authenticateJWT = (req, res, next) => {
  ...
  console.log(
    "[AUTH_MIDDLEWARE] Authorization header:",
  ...
  if (!token) {
    console.warn(
      "[AUTH_MIDDLEWARE WARN] No token provided in cookie or Authorization header",
    );
  ...
  console.log(
    "[AUTH_MIDDLEWARE] Token verified successfully for:",
    decoded.email,
  );
  req.user = {
    id: decoded.userId,
